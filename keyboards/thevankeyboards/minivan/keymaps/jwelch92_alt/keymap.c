...
[_QWERTY] = {
  ...
  {KC_ESC, KC_A,   KC_S,   KC_D, KC_F,   KC_G,   KC_H,   KC_J, KC_K,   KC_L,  KC_SCLN,SFT_T(KC_ENT)},
  {KC_LSFT,KC_Z,   KC_X,   KC_C, KC_V,   KC_B,   KC_N,   KC_M, KC_COMM,    KC_DOT,  KC_UP,   KC_QUOT},
  {KC_LCTL,KC_LALT,KC_LGUI, NUMSYM,XXXXXXX,XXXXXXX,XXXXXXX,KC_SPC,KC_SLSH, KC_LEFT, KC_DOWN, KC_RIGHT}
},
[_NUMSYM] = {
